...
##`2023-06-22` V1.12.10 [download](sbl10e/m365_room/V1.12.10/bm0032_m365_room-sbl10e-setup-1.12.10.bin){.free-downloads}   
>##### **IMPORTANT**
...
***********************************************************************
#### **DOCUMENTATION**  
User manual 1.12.10~002A_en [download](sbl10e/m365_room/V1.12.10/sbl10e-m365-room-user_manual-1.12.10~002A_en.pdf){.free-downloads}
#### **POWERSHELL SCRIPTS FOR AZURE ACTIVE DIRECTORY APPLICATION SUPPORT**   
- PowerShell script 1.10.16 for Azure Active Directory Application support [download](scripts/powershell/Powershell_Innes_AAD-1.10.16.zip){.auth-downloads}
...
`000000000000.js` template 004A for `m365_room` V1.12.10 (or above) [download](sbl10e/m365_room/V1.12.10/configuration-script-template/000000000000.js){.free-downloads}
 
#OLD VERSIONS HISTORY
***********************************************************************

##`2022-05-20` V1.11.13 [download](sbl10e/m365_room/V1.11.13/bm0032_m365_room-sbl10e-setup-1.11.13.bin){.free-downloads}   
>##### **IMPORTANT**
- Change: does support the *discover* command from only Qether V1.12.10 (and above)
- Change: does support the *configure* command from only Qether V1.12.10 (and above)
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2022-05-13` V1.11.12 [download](sbl10e/m365_room/V1.11.12/bm0032_m365_room-sbl10e-setup-1.11.12.bin){.free-downloads}   
>##### **IMPORTANT**
...
- PowerShell script for Azure Active Directory Application support 1.10.13 (or above)
>#### **PREFS.JSON EXAMPLE** 
`prefs.json` example for `m365_room` [download](sbl10e/m365_room/V1.10.15/prefs-json-example/prefs.json){.free-downloads}
