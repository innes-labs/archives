...
##`2023-06-22` V1.12.10 [download](sbl10e/regular/V1.12.10/bm0032_regular-sbl10e-setup-1.12.10.bin){.free-downloads}
>##### **IMPORTANT**
...
***********************************************************************
#### **DOCUMENTATION**  
User manual 1.12.10~002A_en [download](sbl10e/regular/V1.12.10/sbl10e-regular-user_manual-1.12.10~002A_en.pdf){.free-downloads}
#### **QETHER**
[Link to Qether tool](http://www.innes.pro/en/support/index.php?SBL10e/Qether)
#### **CONFIGURATION SCRIPT TEMPLATE** 
`000000000000.js` template 004A for `regular` 1.12.10 (or above) [download](sbl10e/regular/V1.12.10/configuration-script-template/000000000000.js){.free-downloads} 

 
#OLD VERSIONS HISTORY
***********************************************************************

##`2022-05-13` V1.11.12 [download](sbl10e/regular/V1.11.12/bm0032_regular-sbl10e-setup-1.11.12.bin){.free-downloads}
>##### **IMPORTANT**
...
- Qether 1.12.10 (or above)
>#### **PREFS.JSON EXAMPLE** 
`prefs.json` example for `regular` [download](sbl10e/regular/V1.10.15/prefs-json-example/prefs.json){.free-downloads}
