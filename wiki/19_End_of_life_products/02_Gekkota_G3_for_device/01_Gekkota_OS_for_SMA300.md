...
##`2019-03-01` V3.12.58 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.58.zip){.free-downloads}   
...
#### **DOCUMENTATION**  
- User manual (3.12.57/FR) [download](gekkota-os-sma300/sma300-usermanual-3.12.57-001A_fr.pdf){.free-downloads}
- User manual (3.12.57/EN) [download](gekkota-os-sma300/sma300-usermanual-3.12.57-001A_en.pdf){.free-downloads}
- User manual (3.12.57/DE) [download](gekkota-os-sma300/sma300-usermanual-3.12.57-001A_de.pdf){.free-downloads}
#### **SUPPORTED MEDIAS**  
...
##`2018-10-23` V3.12.57 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.57.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2018-01-12` V3.12.51 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.51.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2017-11-10` V3.12.49 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.49.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2017-04-27` V3.12.42 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.42.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2017-04-13` V3.12.41 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.41.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2017-03-29` V3.12.40 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.40.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-11-07` V3.12.37 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.37.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-10-19` V3.12.36 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.36.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-08-29` V3.12.34 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.34.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
- Fix: audio artefact may occur after a while (for example: 1 hour) when playing audio medias with audio output on HDMI 

##`2016-08-09` V3.12.33 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.33.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-06-01` V3.12.31 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.31.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-02-12` V3.12.28 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.28.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
- Fix: unexpected error message *content temporarily unavailable* when playing a same PDF media several times

##`2016-02-03` V3.12.26 [download](gekkota-os-sma300/gekkota_os-sma300-setup-3.12.26.zip){.free-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
- Add DNS suffix
- Add display mode
