...
##`2014-08-20` V2.50.90 [download](playzilla-g2-win32/playzilla-box%20win32-setup-2.50.90.exe){.auth-downloads}   
...
#### **DOCUMENTATION**  
- Stick USB loading (FR) [download](playzilla-g2-win32/Playzilla-chargement-par-clé-usb-003A_fr.pdf){.auth-downloads}
- Multiple screen (FR) [download](playzilla-g2-win32/playzilla-windows-prise-en-charge-des-écrans-multiples.pdf){.auth-downloads}
