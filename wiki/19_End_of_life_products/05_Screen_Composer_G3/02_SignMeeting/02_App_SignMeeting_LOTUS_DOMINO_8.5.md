...
##`2015-12-28` V1.12.14 [download](app-signmeeting-domino-8.5/signmeeting_domino85-screen_composer-setup-1.12.14.appi){.auth-downloads}
>##### **IMPORTANT**
...
#### **DOCUMENTATION**  
- User manual (009A_EN) [download](app-signmeeting-domino-8.5/signmeeting-domino-8-5-user-manual-009A_en.pdf){.auth-downloads}
- User manual (002A FR) [download](app-signmeeting-domino-8.5/signmeeting-domino-8.5-manuel-utilisateur-002A_fr.pdf){.auth-downloads}
...
- Install 'signmeet.nsf' 
	- V1.10.10 for SignMeeting V1.12.13 (and below) [download](app-signmeeting-domino-8.5/webservices/V1.10.10/signmeet.nsf){.auth-downloads}
	- V1.10.11 for SignMeeting V1.12.14 (and above) [download](app-signmeeting-domino-8.5/webservices/V1.10.11/signmeet.nsf){.auth-downloads}
...
##`2015-12-07` V1.12.13 [download](app-signmeeting-domino-8.5/signmeeting_domino85-screen_composer-setup-1.12.13.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
