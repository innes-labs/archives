...
##`2016-06-13` V1.12.19 [download](app-signmeeting-caldav/signmeeting_caldav-screen_composer-setup-1.12.19.appi){.auth-downloads}
...
#### **DOCUMENTATION**  
- User manual (004A/EN) [download](app-signmeeting-caldav/signmeeting-caldav-user-manual-004A_en.pdf){.auth-downloads}
...
##`2016-04-26` V1.12.18 [download](app-signmeeting-caldav/signmeeting_caldav-screen_composer-setup-1.12.18.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
