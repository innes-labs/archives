...
##`2020-01-13` V1.13.11 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.13.11.appi){.auth-downloads}                    
>##### **IMPORTANT**
...
***********************************************************************
#### **DOCUMENTATION**  
- User manual 1.13.11-001E/EN [download](app-signmeeting-simulator/signmeeting-simul-user-manual-1.13.11-001E_en.pdf){.auth-downloads}                                             
#### **CSS FILE FOR THE DIFFERENT DISPLAY PROFILS**
- CSS File V1.13.10 for *Room Screen* display profil  [download](application-notes-signmeeting/room_screen/signmeeting_theme_room_screen_1.13.10.css){.auth-downloads}
...
##`2019-06-17` V1.13.10 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.13.10.appi){.auth-downloads}
>##### **IMPORTANT**
- For users having existing `SignMeeting` projects in the previous version `SignMeeting 1.12.XX`, 
	- Install `Screen Composer V3.20.15`
...
##`2017-08-04` V1.12.27 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.27.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2017-05-22` V1.12.26 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.26.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
- Add support for *German* language
- Fix: it was not possible to program a meeting the day after with SignMeeting (german language only) 

##`2017-01-12` V1.12.23 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.23.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-06-13` V1.12.19 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.19.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-03-10` V1.12.16 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.16.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2016-02-26` V1.12.15 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.15.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2015-12-07` V1.12.13 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.13.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2015-10-12` V1.12.12 [download](app-signmeeting-simulator/signmeeting_simul-screen_composer-setup-1.12.12.appi){.auth-downloads}
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
