...
##`2016-03-10` V1.12.16 [download](app-signmeeting-acropolis/signmeeting_acropolis-screen_composer-setup-1.12.16.appi){.auth-downloads}   
...
#### **DOCUMENTATION**  
- User manual (009A_EN) [download](app-signmeeting-acropolis/signmeeting-acropolis-user-manual-009A_en.pdf){.auth-downloads}
...
- Gestion de porte V1.10.10 [download](application-notes-signmeeting/gestion-de-porte-V1.10.10.zip){.auth-downloads}
...
##`2015-12-07` V1.12.13 [download](app-signmeeting-acropolis/signmeeting_acropolis-screen_composer-setup-1.12.13.appi){.auth-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2015-10-12` V1.12.12 [download](app-signmeeting-acropolis/signmeeting_acropolis-screen_composer-setup-1.12.12.appi){.auth-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
...
##`2015-08-07` V1.12.10 [download](app-signmeeting-acropolis/signmeeting_acropolis-screen_composer-setup-1.12.10.appi){.auth-downloads}   
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
- Initial version