...
// SBL10e generic_server V1.12.10 (or above) (.conf WebDAV directory)
...
function executeScript() {
	...
	// ---- Set datasource URL: uncomment the line after
	//setDatasourceUrl("https://192.168.1.26:443/dir/{$deviceInfo:psn}"); 
	//setDatasourceUrl("https://192.168.1.26:443/dir/{$deviceInfo:mac}"); 

	// ---- Set datasource credential user_password
	//setDatasourceUserPassword("user1", "password1");

	// ---- Disable credential authentication
	//disableCredential();

	// ---- Set datasource heartbeat: uncomment the line after
	//setDatasourceHeartbeat(60);
	...
	// ---------------------------------------
	// Enable/disable CORS (Cross-origin resource sharings) request on SBL10e device (suitable for Web Applications calling SBL10e Web services from Web browsers): uncomment one of the 2 lines after
