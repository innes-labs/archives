...
// SBL10e m365_room V1.12.10 (or above) (.conf WebDAV directory)
...
function executeScript() {
	...
	//setDatasourceClientSecret("your_client_secret_value"); 

	// ---- Set datasource resource Id (the account email of the resource): uncomment the line after
	//setDatasourceResourceId("room1@demo-contoso.onmicrosoft.com"); 

	// ---- Set datasource heartbeat: uncomment the line after
	//setDatasourceHeartbeat(60); // duration in seconds between two following connections to M365 
...
function setDatasourceTenantId(tenant_id) {
	setStringPref("appli.network.datasource.credential.oauth_client_credentials_grant.tenant_id", tenant_id);
}
function setDatasourceClientId(client_id) {
	setStringPref("appli.network.datasource.credential.oauth_client_credentials_grant.client_id", client_id);
}
function setDatasourceClientSecret(client_secret) {
	setStringPref("appli.network.datasource.credential.oauth_client_credentials_grant.client_secret", client_secret);
}
