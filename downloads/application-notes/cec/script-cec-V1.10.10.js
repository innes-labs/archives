(function () {
  ...
  var standbyTime = "16:45";

  /** Start the screen (hours:minutes) */
  var onTime = "16:50";

  /** Active HMDI source (hours:minutes)*/
  var activeSrcTime = "16:55";
  ...
  function SetActiveSource() {
    try {
      ...
      cec.sendMsg(cec.CECDEVICE_PLAYBACKDEVICE1, cec.CECDEVICE_BROADCAST, bytesMessage, false, 0, messageEventHandler);
    } catch (ex) {
      LOG("Exception : " + ex);
    }
  }
  ...
  function SetStandbyTV() {
    try {
      ...
      cec.sendMsg(cec.CECDEVICE_PLAYBACKDEVICE1, cec.CECDEVICE_TV, bytesMessage, false, 0, messageEventHandler);
    } catch (ex) {
      LOG("Exception : " + ex);
    }
  }
