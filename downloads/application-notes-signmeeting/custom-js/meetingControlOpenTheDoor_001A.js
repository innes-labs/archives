/**
 * Meetingroom door control : allows to open the electric door by using the tablet GPIO each time the user presses on the "Déverrouiller la porte" button on the screen
 *
