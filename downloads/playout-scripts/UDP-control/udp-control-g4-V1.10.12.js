(function () {
	...
	//==================================================================================================
	// VERSION 1.10.12 (for Gekkota 4 devices only)
	//- Activate the VESA DPMS for the concerned devices
	//- Create a type `text` variable name (ex: `videoSource`), whose name has to be also defined in `VAR_NAME` of the playout script `udp-control-g4-V1.10.12.js`, and create values for this variable
	...
	//- Insert the udp-control-g4-V1.10.12.js script in the playout script to execute
