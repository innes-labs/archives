...
// SAP10e generic_server V1.11.10 (or above) (.conf WebDAV directory)
...
function executeScript() {
	...
	//setIPv4StaticAddress("192.168.10.212", "255.255.128.0", "192.168.0.1"); // ---- Set static IP address for IPV4, netmask and gateway
	...
	// ---- Set datasource URL (IPV4 address or domain name are supported): uncomment the line after and adjust with your own remote file server 
	//setDatasourceUrl("http://192.168.1.78:8081/path_to_slates_folder/{$deviceInfo:psn}");
	//setDatasourceUrl("http://192.168.1.78:8081/path_to_slates_folder/{$deviceInfo:mac}");
	//setDatasourceUrl("http://192.168.1.78:8081/path_to_slates_folder/01390-00004");
	// ---- Set datasource credential user_password. uncomment one of the 2 lines after
	//setDatasourceUserPassword("user1", "password1");
	//disableCredential();
	// ---- Set datasource heartbeat: uncomment the line after
	//setDatasourceHeartbeat(180);
	
	// ---- Enable/Disable proxy: uncomment one of the 2 lines after
	//enableProxy(); // ---- This one to enable UPNP
	//disableProxy(); // ---- This one to disable UPNP
	// ---- Set proxy URL hostname, can be IP address or domain name: uncomment the 2 lines after
	//setProxyUrlHostname("192.168.1.35");
	//setProxyPort(3128);
	...
	// ---- Defines system date&time timezone, refer to the SAP10e user manual to know the timezone values: uncomment the line after
...
function checkCompatibility() {
	...
	if (getFirmwareApp() != "generic_server") {
		return false;
	}
...
function setDatasourceUrl(url) {
	setStringPref("appli.network.datasource.url", url);
}
